 ...
 * Time: 20:06
 **/
public abstract class HeartBaseView extends View {
    ...
    public HeartBaseView(Context context) {
        this(context, null, 0);
    }

    public HeartBaseView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HeartBaseView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

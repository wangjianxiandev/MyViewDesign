 ...
 * Time: 19:25
 */
public class HeartBeiJiAiTest extends HeartBaseView {
    ...
    public HeartBeiJiAiTest(Context context) {
        super(context);
    }

    public HeartBeiJiAiTest(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HeartBeiJiAiTest(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
